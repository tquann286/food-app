    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(DeliveryRegistration.this,android.R.layout.simple_spinner_item,state.get(statee));
                                                        ...
                                                        FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                ...
                                                                if(task.isSuccessful()){
                                                                    ...
                                                                    mDialog.dismiss();
                                                                    ReusableCodeForAll.ShowAlert(DeliveryRegistration.this,"Có lỗi xảy ra, vui lòng thử lại sau",task.getException().getMessage());
                                                                }
                                                            }
                                                        });
                                                    }
