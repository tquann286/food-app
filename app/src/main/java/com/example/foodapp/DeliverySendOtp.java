                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(DeliverySendOtp.this, "Đăng nhập thành công", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(DeliverySendOtp.this,ChefFoodPanel_BottomNavigation.class));
                            finish();
                        }else{
                            ReusableCodeForAll.ShowAlert(DeliverySendOtp.this,"Lỗi",task.getException().getMessage());
                        }
                    }
                });
