                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    if(Fauth.getCurrentUser().isEmailVerified()){
                                        ...
                                        ReusableCodeForAll.ShowAlert(Login.this,"Đăng nhập thất bại","Bạn chưa xác thực email.");

                                    }
                                }else{
                                    mDialog.dismiss();
                                    ReusableCodeForAll.ShowAlert(Login.this,"Lỗi",task.getException().getMessage());
                                }
                            }
                        });
                    }
