                ...
                .addOnCompleteListener(DeliveryVerifyPhone.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(DeliveryVerifyPhone.this, "Đăng ký thành công", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(DeliveryVerifyPhone.this , MainMenu.class);
                            startActivity(intent);
                            finish();
                        }else{
                            ReusableCodeForAll.ShowAlert(DeliveryVerifyPhone.this,"Có lỗi xảy ra, vui lòng thử lại",task.getException().getMessage());
                        }
                    }
                });
